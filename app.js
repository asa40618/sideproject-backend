...
import testRouter from './routes/example/test-1.js'

import courseRouter from './routes/course.js'
import memberAuthJwtRouter from './routes/member/auth-jwt.js'
...
import event_management from './routes/event_management/event_management.js'
...
app.use(
  cors({
    origin: [
      ...
      'https://side-project-frontend-iota.vercel.app',
    ],
...
app.use('/api/member/', memberAuthJwtRouter)
app.use('/api/users', usersRouter)
app.use('/api/reset-password', resetPasswordRouter)
app.use('/api/favorite', favoriteRouter)
app.use('/api/evaluate', evaluateRouter)
app.use('/api/ranking', rankingRouter)
app.use('/api/product/event-management', event_management)
